...
public class TestStepsCombo extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		TEST_REPORT_CONTEXT.set(ContextKeys.CONTEXT_KEY_GROUPING_COLUMNS, Scenario1.GROUPING_COLUMNS); 
		TEST_REPORT_CONTEXT.set(ContextKeys.CONTEXT_KEY_DATA_COLUMNS, Scenario1.DATA_COLUMNS);
