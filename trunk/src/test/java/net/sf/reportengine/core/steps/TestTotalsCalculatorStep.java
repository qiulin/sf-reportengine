...
public class TestTotalsCalculatorStep extends ReportAlgorithmStepTC {
    ...
    public void testExecuteScenario1() {
    	...
    	reportContext.set(GroupingLevelDetectorStep.CONTEXT_KEY_NEW_GROUPING_LEVEL, Scenario1.AGG_COLUMNS_INDEX);
		...
		ICalculator[][] calcMatrix = (ICalculator[][])reportContext.get(TotalsCalculatorStep.CONTEXT_KEY_CALCULATORS);
    ...
    public void testExecuteScenario2(){
        ...
        //simulate the level detector
    	reportContext.set(FlatReport.CONTEXT_KEY_DATA_COLUMNS, Scenario2.DATA_COLUMNS);
    	reportContext.set(AbstractReport.CONTEXT_KEY_GROUPING_COLUMNS, Scenario2.GROUPING_COLUMNS);
        ...
        for(int i=0; i<CalculatedColumnsScenario.RAW_DATA.length; i++){
        	...
        	reportContext.set(ComputeColumnValuesStep.CONTEXT_KEY_COMPUTED_CELL_VALUES, Scenario2.COMPUTED_INPUT[i]);
    ...
    public void testExecuteCalculatedColumnsScenario(){
        ...
        for(int i=0; i<CalculatedColumnsScenario.RAW_DATA.length; i++){
        	...
        	reportContext.set(ComputeColumnValuesStep.CONTEXT_KEY_COMPUTED_CELL_VALUES, CalculatedColumnsScenario.COMPUTED_VALUES[i]);
