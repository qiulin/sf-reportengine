...
public class TestHtmlReportOutput {
	...
	public void testUtf8Characters() throws IOException {
		...
		HtmlReportOutput testOutput = new HtmlReportOutput(
		...
		assertEquals("<p style=\"text-align: center; vertical-align: middle\">На берегу пустынных волн</p>", lines.get(0));
		assertEquals("<p style=\"text-align: center; vertical-align: middle\">Τη γλώσσα μου έδωσαν ελληνική</p>", lines.get(1)); 
