 ...
 * (otherwise the reportengine will see a change of group everywhere)
 * In this example, the input data for the flat table is not sorted and the reportengine 
 * is informed about this by using the sortValues() method in the FlatTable builder class. 
 */
public class UnsortedGroupValues {
	...
	public static void main(String[] args) throws IOException {
		...
		new Report.Builder(new HtmlReportOutput(new FileWriter("./target/MonthlyExpensesFromUnsortedInput.html")))
